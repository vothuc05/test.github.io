...
<html>
 ...
 <body>
  ...
  <br><br><br>
  <center>
   <h1>** Radio Việt Nam **</h1>
    <h1>** <VAR></VAR>Vietbroadcast.vn**</h1>
   <button class="button" onclick="httpGet('dpre=1')">PREV</button>
   <button class="button" onclick="httpGet('upre=1')">NEXT</button>
   <button class="button" onclick="httpGet('dvol=2')">VOL-</button>
   <button class="button" onclick="httpGet('uvol=2')">VOL+</button>
   <button class="button" onclick="httpGet('vol=0')">(un)MUTE</button>
   <button class="button" onclick="httpGet('ply=0')">STOP</button>
   <button class="button" onclick="httpGet('ply=1')">PLAY</button>
   ...
   <br><br>
   <p>NM:VNR_1101E | FW:TU1_2.2.6 | HW:V3.0</p><br>
  </center>
  <script>
   ...
   function setstat()
   {
     var theUrl = "/?dlk=" + station.value + "&version=" + Math.random() ;
     var xhr = new XMLHttpRequest() ;
     xhr.onreadystatechange = function() {
       if ( xhr.readyState == XMLHttpRequest.DONE )
       {
